 ...
 */
package com.hep.memberapi.jalo;
...
/**
 * This is the extension manager of the Memberapi extension.
 */
public class MemberapiManager extends GeneratedMemberapiManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(MemberapiManager.class);
	...
	{
		return (MemberapiManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(MemberapiConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public MemberapiManager() // NOPMD 
	{
		LOG.debug("constructor of MemberapiManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of MemberapiManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of MemberapiManager called, current tenant: {}", getTenant().getTenantID());
	}
