...
public class DefaultMemberapiService implements MemberapiService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultMemberapiService.class);
	...
	{
		return DefaultMemberapiService.class.getResourceAsStream("/memberapi/sap-hybris-platform.png");
	}
