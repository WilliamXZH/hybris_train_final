...
import com.hep.hand.data.UserDataList;
import com.hep.hand.dto.SampleWsDTO;
import com.hep.hand.dto.TestMapWsDTO;
import com.hep.hand.dto.UserWsDTO;
import com.hep.hand.dto.UsersListWsDTO;
import com.hep.hand.facades.SampleFacades;
import com.hep.hand.initializer.TestBean;
...
public class SampleController
{
	 ...
	 * Example :</br>
	 * GET http://localhost:9001/hepwebservice/sample/dto/sampleValue
	 *
	 * @param pathVariable
	 ...
	 * Example :</br>
	 * URL : http://localhost:9001/hepwebservice/sample/dto</br>
	 * Method : POST</br>
	 ...
	 * <ul>
	 * <li>http://localhost:9001/hepwebservice/sample/users
	 * <li>http://localhost:9001/hepwebservice/sample/users?fields=users(info)
	 * <li>http://localhost:9001/hepwebservice/sample/users?fields=users(BASIC)
	 * <li>http://localhost:9001/hepwebservice/sample/users?fields=users(DEFAULT)
	 * <li>http://localhost:9001/hepwebservice/sample/users?fields=users(FULL)
	 * <li>http://localhost:9001/hepwebservice/sample/users?fields=users(firstName,addresses(street))
	 * </ul>
	 */
	 ...
	 * <ul>
	 * <li>http://localhost:9001/hepwebservice/sample/users/user1
	 * <li>http://localhost:9001/hepwebservice/sample/users/user1?fields=info
	 * <li>http://localhost:9001/hepwebservice/sample/users/user1?fields=BASIC
	 * <li>http://localhost:9001/hepwebservice/sample/users/user1?fields=DEFAULT
	 * <li>http://localhost:9001/hepwebservice/sample/users/user1?fields=FULL
	 * <li>http://localhost:9001/hepwebservice/sample/users/user1?fields=firstName,addresses(street)
	 * </ul>
	 */
	 ...
	 *
	 * Url: http://localhost:9001/hepwebservice/sample/map
	 *
	 */
