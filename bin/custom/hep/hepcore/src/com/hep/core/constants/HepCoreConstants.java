 ...
 */
package com.hep.core.constants;

/**
 * Global class for all HepCore constants. You can add global constants for your extension into this class.
 */
public final class HepCoreConstants extends GeneratedHepCoreConstants
{
	public static final String EXTENSIONNAME = "hepcore";


	private HepCoreConstants()
	{
		//empty
	}
